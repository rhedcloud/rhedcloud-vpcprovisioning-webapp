...
public class ConsoleFeaturePojo extends SharedObject implements IsSerializable, Comparable<ConsoleFeaturePojo> {
	/*
	<!ELEMENT Service (
		ServiceId?, 
		AwsServiceCode, 
	...
	ConsoleFeaturePojo baseline;
	boolean skeleton;
	
	String name;
	String actionName;	// constant used to tell the client which presenter to use
	boolean popular;
	...
	public static final ProvidesKey<ConsoleFeaturePojo> KEY_PROVIDER = new ProvidesKey<ConsoleFeaturePojo>() {
		@Override
		public Object getKey(ConsoleFeaturePojo item) {
			return item == null ? null : item.getAwsServiceName();
		}
	};

	public ConsoleFeaturePojo() {
	}
	...
	public ConsoleFeaturePojo getBaseline() {
		return baseline;
	}


	public void setBaseline(ConsoleFeaturePojo baseline) {
...
//		}
	...
	@Override
	public int compareTo(ConsoleFeaturePojo o) {
