...
public class IncidentPojo extends SharedObject implements IsSerializable, Comparable<IncidentPojo> {
	...
	public IncidentPojo getBaseline() {
		return baseline;
	}

	public void setBaseline(IncidentPojo baseline) {
		this.baseline = baseline;
	}

	@Override
	public int compareTo(IncidentPojo o) {
