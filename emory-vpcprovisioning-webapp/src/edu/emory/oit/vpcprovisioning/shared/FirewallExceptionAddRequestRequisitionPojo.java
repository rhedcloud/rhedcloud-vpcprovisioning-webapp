...
public class FirewallExceptionAddRequestRequisitionPojo extends SharedObject implements IsSerializable, Comparable<FirewallExceptionAddRequestRequisitionPojo> {
	/*
<!ELEMENT FirewallExceptionAddRequestRequisition (
	UserNetID, 
	ApplicationName, 
	SourceOutsideEmory, 
	TimeRule, 
	...
	String vpnName;
	String accessAwsVPC;
	FirewallExceptionAddRequestRequisitionPojo baseline;
	
	public FirewallExceptionAddRequestRequisitionPojo() {
		// TODO Auto-generated constructor stub
	}

	@Override
	public int compareTo(FirewallExceptionAddRequestRequisitionPojo o) {
	...
	public FirewallExceptionAddRequestRequisitionPojo getBaseline() {
		return baseline;
	}

	public void setBaseline(FirewallExceptionAddRequestRequisitionPojo baseline) {
