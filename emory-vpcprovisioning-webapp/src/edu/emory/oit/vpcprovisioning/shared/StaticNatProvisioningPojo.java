...
public class StaticNatProvisioningPojo extends SharedObject implements IsSerializable, Comparable<StaticNatProvisioningPojo> {
	...
	public StaticNatProvisioningPojo getBaseline() {
		return baseline;
	}

	public void setBaseline(StaticNatProvisioningPojo baseline) {
		this.baseline = baseline;
	}

	@Override
	public int compareTo(StaticNatProvisioningPojo o) {
