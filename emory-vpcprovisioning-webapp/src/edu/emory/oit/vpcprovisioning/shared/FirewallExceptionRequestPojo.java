...
public class FirewallExceptionRequestPojo extends SharedObject implements IsSerializable, Comparable<FirewallExceptionRequestPojo> {
	...
	/*
	 7/12/2018 definition
	(SystemId?, NeedFirewall?, RemoveItem?, UserNetID, ApplicationName, 
	SourceOutsideEmory, TimeRule, ValidUntilDate?, SourceIpAddresses, 
	DestinationIpAddresses, Ports, BusinessReason, Patched, 
	DefaultPasswdChanged, AppConsoleACLed, Hardened, PatchingPlan, 
	Compliance*, OtherCompliance?, SensitiveDataDesc, LocalFirewallRules, 
	DefaultDenyZone, Tag+, TechContact?, RequestNumber?,  RequestState?, 
	RequestItemNumber?,  RequestItemState?)> 
	
	 original definition (when i had it working)
