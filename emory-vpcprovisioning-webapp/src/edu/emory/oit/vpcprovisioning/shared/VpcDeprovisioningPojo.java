...
public class VpcDeprovisioningPojo extends SharedObject implements IsSerializable, Comparable<VpcDeprovisioningPojo> {
	...
	VpcDeprovisioningPojo baseline;
...
//	}
	...
	public static final ProvidesKey<VpcDeprovisioningPojo> KEY_PROVIDER = new ProvidesKey<VpcDeprovisioningPojo>() {
		@Override
		public Object getKey(VpcDeprovisioningPojo item) {
			return item == null ? null : item.getProvisioningId();
		}
	};

	public VpcDeprovisioningPojo() {
		
	}

	@Override
	public int compareTo(VpcDeprovisioningPojo o) {
	...
	public VpcDeprovisioningPojo getBaseline() {
		return baseline;
	}

	public void setBaseline(VpcDeprovisioningPojo baseline) {
