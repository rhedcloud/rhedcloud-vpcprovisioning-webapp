...
public abstract class HTMLUtils {
	...
	public static SafeHtml getProgressBarSafeHtml(int totalSteps, int completedSteps) {
        ...
        sb.appendHtmlConstant("<div style='z-index: 2; display: inline; width: 250px; position: absolute; left: 0px, top: 0px; text-align: center;'>"
                + completedSteps
                + "/"
                + totalSteps
                + "</div>");
        sb.appendHtmlConstant("<div style='position: absolute; left: 0; top: 0; width: 250px; z-index: 1'><div style='display: inline; float: left; width: "
                + rounded
                + "%; height: 20px; background-color: #90EE90;'></div>");
